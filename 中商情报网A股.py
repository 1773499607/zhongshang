...
from urllib.parse import urlencode  # 编码 URL 字符串  urllib库里面有个urlencode函数，可以把key-value这样的键值对转换成我们想要的格式，返回的是a=1&b=2这样的字符串
...
def get_one_page(i):
   try:
      ...
      url = 'http://s.askci.com/stock/a/?' + urlencode(paras)    #reportTime=2017-12-31&pageNum=1
